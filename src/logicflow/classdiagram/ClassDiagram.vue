      ...
      <el-form :model="classForm">
        ...
        <el-form-item label="属性：">
          ...
          <el-row v-for="field in classForm.fields" style="width: 100%">
            <el-col :span="4">{{ field.name }}</el-col><el-col :span="2">{{ field.type }}</el-col><el-col :span="18">{{ field.desc }}</el-col>
          </el-row>
        </el-form-item>
        <el-form-item label="方法：" >
          <el-row style="width: 100%">
            <el-col :span="4">方法名</el-col><el-col :span="5">参数类型</el-col><el-col :span="5">返回类型</el-col><el-col :span="10">描述</el-col>
          </el-row>
          <el-row v-for="method in classForm.methods" style="width: 100%">
            <el-col :span="4">{{ method.name }}</el-col><el-col :span="8">{{ method.args }}</el-col><el-col :span="2">{{ method.returnType }}</el-col><el-col :span="10">{{ method.desc }}</el-col>
          </el-row>
        </el-form-item>
