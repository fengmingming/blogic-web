<template>
    <MainContainer>
        <template #default>
            <el-row>
                <el-col :span="18">
                    <div style="padding-top: 10px">
                        <div><el-text>[标题]</el-text></div>
                        <div style="padding-top: 10px">
                            {{ bug.title }}
                        </div>
                    </div>
                    <div style="padding-top: 10px">
                        <div><el-text>[重新步骤]</el-text></div>
                        <div style="padding-top: 10px">
                            <RichEditor v-model="bug.reproSteps" :disabled="true"/>
                        </div>
                    </div>
                    <div style="padding-top: 10px">
                        <div><el-text>[结果]</el-text></div>
                        <div style="padding-top: 10px">
                            TODO 结果
                        </div>
                    </div>
                    <div style="padding-top: 10px">
                        <div><el-text>[期望]</el-text></div>
                        <div style="padding-top: 10px">
                            TODO 期望
                        </div>
                    </div>
            ...
            <el-divider />
            <ChangeRecord :primaryKey="bug.id" :keyType="13"/>
